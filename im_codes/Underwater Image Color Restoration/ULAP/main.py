...
#refineDR = np.clip(refineDR, 0,1)
#
#cv2.imwrite('ULAP_DM_deepBlue.jpg', np.uint8(refineDR * 255))
#
#AtomsphericLight = BLEstimation(img, DepthMap) * 255
#
#d_0 = minDepth(img, AtomsphericLight)
...
#
#cv2.imwrite('ULAP_TM_deepBlue.jpg', np.uint8(transmission * 255))
#cv2.imwrite('ULAP_deepBlue.jpg', sceneRadiance)